...
void mix (char matriz[MAXL][MAXC], int nL, int nC, int* onibus, int *passageiros, int ciclos, int* contagem_ciclos){
    ...
    while ((*contagem_ciclos) < ciclos)
    {
        ...
        switch (mov) {
            case EMFRENTE:
                ...
                emFrente(matriz, nL, nC, onibus, passageiros, ciclos_temporario, contagem_ciclos);
                break;
            ...
            case BUSCINTEL:
                ...
                buscaInteligente(matriz, nL, nC, onibus, passageiros, ciclos_temporario, contagem_ciclos);
                break;
