...
#endif
//////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////Inicio dos prototipos ou defini��es /////////////////////////
//////////////////////////////////////////////////////////////////////////////////////////////
...
//incluir os outros prot�tipos necess�rios

int main()
{

   // aten��o utilizar as macros definidas no in�cio do programa
   char mat[MAXL][MAXC];
...
int defineDirecao(...){
  //implementar os comandos necess�rios

}

void movimentaOnibus(...){

    //incluir o la�o de repeti��o e completar o que for necess�rio para o movimento do �nibus


        //incluir os comandos ou fun��es para atualizar o mapa com o movimento do �nibus

        imprimeMapa(...);
        DORME(...); //definir o tempo que segura a tela no v�deo
        LIMPATELA();
...
// incluir aqui as defini��es das outras fun��es necess�rias
